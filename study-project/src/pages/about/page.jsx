import AImage from '/Users/june/Documents/GitHub/Team2_June/study-project/src/assets/images/A.png';
import BImage from '/Users/june/Documents/GitHub/Team2_June/study-project/src/assets/images/B.png';
import CImage from '/Users/june/Documents/GitHub/Team2_June/study-project/src/assets/images/C.png';
	...
	return (
		<div className="flex flex-col items-center justify-center ">
			...
			<div className=" flex flex-col flex-grow mx-auto w-1/2">
				...
				<p className="pt-3 text-sm text-center">KW-HCC Lab 소속 프론트엔드 개발에 관심있는 사람들이 모여 만든 그룹이에요.</p>

				<p className="pt-16 text-2xl font-semibold text-center">여기에서는</p>
				<p className="pt-3 text-sm text-center">누구나 편하게 자신의 FE 개발 경험담, 고민 등의 이야기를 편하게 나눌 수 있어요.</p>
				<p className="text-sm text-center">모든 분야의 사용자에 대하여 연구하고 좋은 경험을 제공할 수 있는 방법을 이야기해보아요.</p>
